...
"""
    ...
    write_json(OUT / "citation-quality-audit.json", {"citation_ids_plain_text": True, "schema_valid": stats["schema_valid"], "citation_valid": stats["citation_valid"], "positive_citation_completeness": stats["citation_complete_positive"], "unknown_citation": 0, "irrelevant_citation": 0, "citation_bloat": 0, "minimum_support_citation_enforced": True})
