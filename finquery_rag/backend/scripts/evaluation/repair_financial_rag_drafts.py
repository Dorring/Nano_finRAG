...
PLANS: dict[str, dict[str, Any]] = {
    ...
    "nvda_fy2025": {
        ...
        "table_b": _metric("Automotive revenue", section="Revenue by market platform", table_title="Revenue by market platform"),
        "multi": {
...
def repair(
    ...
    for original_question in questions:
        ...
        question_overrides = {
            ...
            "nvda_fy2025_005": "In the Revenue by market platform table, what was Automotive revenue in FY2025?",
